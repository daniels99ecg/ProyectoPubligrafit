import {
  ...
  useTransition
} from "./chunk-V47LXWAK.js";
import "./chunk-CRT5IFFE.js";
import "./chunk-5M5TLZO7.js";
import "./chunk-LDXE53RB.js";
import "./chunk-G6TXRTOD.js";
import "./chunk-CSC2LDEO.js";
import "./chunk-6NN73KMD.js";
import "./chunk-AOKQVTWL.js";
import "./chunk-KDPKWFXE.js";
import {
  composeClasses,
...
import "./chunk-SX76XFL7.js";
import "./chunk-5MOCHVGZ.js";
import {
  require_jsx_runtime
...
var _excluded22 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
...
var _excluded3 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
var getLabelPosition = (formattedArcLabel, variable) => (startAngle, endAngle, padAngle, innerRadius, outerRadius, cornerRadius) => {
...
var _excluded4 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "arcLabel", "arcLabelMinAngle", "skipAnimation"];
var _excluded23 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
  ...
  return (0, import_jsx_runtime6.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime5.jsx)("g", {
        transform: `translate(${cx === void 0 ? center.x : left + cx}, ${cy === void 0 ? center.y : top + cy})`,
...
true ? PieChart.propTypes = {
  ...
  series: import_prop_types3.default.arrayOf(import_prop_types3.default.shape({
    arcLabel: import_prop_types3.default.oneOfType([import_prop_types3.default.oneOf(["formattedValue", "label", "value"]), import_prop_types3.default.func]),
    arcLabelMinAngle: import_prop_types3.default.number,
    color: import_prop_types3.default.string,
    cornerRadius: import_prop_types3.default.number,
    cx: import_prop_types3.default.number,
    cy: import_prop_types3.default.number,
    data: import_prop_types3.default.arrayOf(import_prop_types3.default.shape({
      color: import_prop_types3.default.string,
    ...
    faded: import_prop_types3.default.shape({
      additionalRadius: import_prop_types3.default.number,
      color: import_prop_types3.default.string,
      cornerRadius: import_prop_types3.default.number,
      innerRadius: import_prop_types3.default.number,
      outerRadius: import_prop_types3.default.number,
      paddingAngle: import_prop_types3.default.number
    }),
    highlighted: import_prop_types3.default.shape({
      additionalRadius: import_prop_types3.default.number,
      color: import_prop_types3.default.string,
      cornerRadius: import_prop_types3.default.number,
      innerRadius: import_prop_types3.default.number,
    ...
    outerRadius: import_prop_types3.default.number,
    paddingAngle: import_prop_types3.default.number,
    sortingValues: import_prop_types3.default.oneOfType([import_prop_types3.default.oneOf(["asc", "desc", "none"]), import_prop_types3.default.func]),
    startAngle: import_prop_types3.default.number,
    type: import_prop_types3.default.oneOf(["pie"]),
