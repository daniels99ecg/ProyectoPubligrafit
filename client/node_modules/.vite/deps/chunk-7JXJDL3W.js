...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React12.useContext(SVGContext);
  const {
    width,
    height,
    top,
...
var ChartsSurface = React13.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
function ChartsText(props) {
  ...
  const wordsByLines = React16.useMemo(() => getWordsByLines({
    style,
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React18.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React19.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
...
function useMouseTracker() {
  const svgRef = React21.useContext(SVGContext);
  const [mousePosition, setMousePosition] = React21.useState(null);
  React21.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
//# sourceMappingURL=chunk-7JXJDL3W.js.map
