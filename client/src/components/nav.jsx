...
function Nav() {
  ...
  const userPermissions = user ? user.permisos : [];
        ...
        <div className="dashboard-nav" >
          ...
          <nav className="dashboard-nav-list">
            ...
            <div className='dashboard-nav-dropdown'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="42" height="20" fill="currentColor" className="bi bi-gear-fill" viewBox="0 0 16 16" style={{marginLeft: -50}}>
  <path d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z"></path>
</svg>
                 Configuración </a>
              <div className='dashboard-nav-dropdown-menu'>
              {userPermissions.includes('Rol') && (

                <a href="/rol" className="dashboard-nav-dropdown-item">
              ...
              {userPermissions.includes('Usuario') && (

                <a href="/usuario" className="dashboard-nav-dropdown-item">
              ...
              <a href="/rol/create/permiso" className="dashboard-nav-dropdown-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="22" fill="currentColor" className="bi bi-people-fill" viewBox="0 0 16 16">
                    <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"></path>
                  </svg>
                  Permisos</a>
            ...
            <div className='dashboard-nav-dropdown'>
              ...
              <a href="/compras#!" className="dashboard-nav-item dashboard-nav-dropdown-toggle">
              <svg xmlns="http://www.w3.org/2000/svg" width="45" height="22" fill="currentColor" className="bi bi-cart-check-fill" viewBox="0 0 16 16" style={{marginLeft: -50}}>
              ...
              <div className='dashboard-nav-dropdown-menu'>
              {userPermissions.includes('Insumo') && (

                <a href="/insumo" className="dashboard-nav-dropdown-item">
...
<div className='dashboard-nav-dropdown'>
  ...
  <a href="/venta#!" className="dashboard-nav-item dashboard-nav-dropdown-toggle">
  <svg xmlns="http://www.w3.org/2000/svg" width="45" height="20" fill="currentColor" className="bi bi-bag-check-fill" viewBox="0 0 16 16" style={{marginLeft: -50}}>
  <path fillRule="evenodd" d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5v-.5zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0zm-.646 5.354a.5.5 0 0 0-.708-.708L7.5 10.793 6.354 9.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z"></path>
              ...
              <div className='dashboard-nav-dropdown-menu'>
              {userPermissions.includes('Producto') && (

                <a href="/producto" className="dashboard-nav-dropdown-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="20" fill="currentColor" className="bi bi-box2-fill" viewBox="0 0 16 16" >
                  ...
                  {userPermissions.includes('Cliente') && (

                  <a href="/cliente" className="dashboard-nav-dropdown-item">
        ...
        <header className='dashboard-toolbar d-flex justify-content-between align-items-center'>
            ...
            {user && (
              <>
                ...
                <span className="user-icon-separator">&nbsp;</span>
                <span className="user-icon-separator">&nbsp;</span>
                <span className="user-icon-separator">&nbsp;</span>
