...
var Badge = React4.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime5.jsxs)(Root, _extends({}, rootProps, {
    children: [children2, (0, import_jsx_runtime4.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React22.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
...
var Menu = React24.forwardRef(function Menu2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime12.jsx)(Popper, _extends({}, rootProps, {
    open,
    anchorEl: anchor,
    slots: {
      root: Root
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React25.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React26.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children: children2,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const itemMetadata = React27.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React27.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  ...
  const localGetItemState = React28.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React28.useMemo(() => ({
    dispatch,
...
var InnerMenuItem = React29.memo(React29.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    disabled: disabledProp = false,
...
var MenuItem2 = React29.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var Modal = React31.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    closeAfterTransition = false,
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React32.useState(value ? String(value) : void 0);
  React32.useEffect(() => {
...
var NumberInput = React33.forwardRef(function NumberInput2(props, forwardedRef) {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime24.jsx)(React42.Fragment, {
...
var TextareaAutosize = React62.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime42.jsxs)(React62.Fragment, {
...
var FormControlContext2 = React63.createContext(void 0);
if (true) {
...
function useFormControl() {
  return React64.useContext(FormControlContext_default);
}
...
var _excluded24 = ["aria-describedby", "autoComplete", "autoFocus", "className", "color", "components", "componentsProps", "defaultValue", "disabled", "disableInjectingGlobalStyles", "endAdornment", "error", "fullWidth", "id", "inputComponent", "inputProps", "inputRef", "margin", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onClick", "onFocus", "onKeyDown", "onKeyUp", "placeholder", "readOnly", "renderSuffix", "rows", "size", "slotProps", "slots", "startAdornment", "type", "value"];
...
var Paper = React67.forwardRef(function Paper2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPaper"
  });
  ...
  return (0, import_jsx_runtime46.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UWTBSFA6.js.map
