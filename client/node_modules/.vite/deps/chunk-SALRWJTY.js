...
function CartesianContextProvider({
  ...
  const drawingArea = React7.useContext(DrawingContext);
...
var InteractionContext = React8.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider({
  ...
  const [data, dispatch] = React8.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
...
var HighlighContext = React9.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider({
  ...
  const [data, dispatch] = React9.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React9.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var useInteractionItemProps = (scope) => {
  ...
  } = React10.useContext(HighlighContext);
...
//# sourceMappingURL=chunk-SALRWJTY.js.map
