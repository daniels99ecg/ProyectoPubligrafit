import {
  ListContext_default,
  Select_default
} from "./chunk-CIUVKNP2.js";
import {
  Typography_default
} from "./chunk-ZLBTS2PG.js";
import {
  IconButton_default
} from "./chunk-SGJ4H3RB.js";
import {
  FormControlContext_default,
  InputBase_default,
  formControlState,
  useFormControl
} from "./chunk-2UZ3WYCN.js";
import {
  getUnit,
  toUnitless
} from "./chunk-N6TNPWQ5.js";
import {
  ButtonBase_default
} from "./chunk-QI3G6X72.js";
import {
  init_useId,
  useId_default
} from "./chunk-B75Q2HXX.js";
import {
  init_useControlled,
  useControlled_default
} from "./chunk-MW4SFB7V.js";
import {
  createSvgIcon,
  init_createSvgIcon,
  init_useEnhancedEffect,
  useEnhancedEffect_default
} from "./chunk-6JQGBZIC.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-ACTHNCHO.js";
import {
  useBadge
} from "./chunk-VKNQ4R3X.js";
import {
  isHostComponent,
  useSlotProps
...
import {
  useTheme
} from "./chunk-GSAFU3UN.js";
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-HWCW3FFG.js";
import {
...
true ? Divider.propTypes = {
   ...
   * @default false
   */
  absolute: import_prop_types6.default.bool,
  /**
   ...
   * @default false
   */
  flexItem: import_prop_types6.default.bool,
  /**
   ...
   * @default 'center'
   */
  textAlign: import_prop_types6.default.oneOf(["center", "left", "right"]),
  /**
   * The variant to use.
   * @default 'fullWidth'
   */
  variant: import_prop_types6.default.oneOfType([import_prop_types6.default.oneOf(["fullWidth", "inset", "middle"]), import_prop_types6.default.string])
} : void 0;
...
var FormControlLabel = React9.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsxs)(FormControlLabelRoot, _extends({
    ...
    children: [React9.cloneElement(control, controlProps), required ? (0, import_jsx_runtime12.jsxs)(Stack_default, {
      display: "block",
...
var _excluded12 = ["className", "color", "edge", "size", "sx"];
...
var Switch = React15.forwardRef(function Switch2(inProps, ref) {
  ...
  const icon = (0, import_jsx_runtime20.jsx)(SwitchThumb, {
    className: classes.thumb,
    ownerState
  });
  return (0, import_jsx_runtime21.jsxs)(SwitchRoot, {
    className: clsx_default(classes.root, className),
    sx,
    ownerState,
    children: [(0, import_jsx_runtime20.jsx)(SwitchSwitchBase, _extends({
      type: "checkbox",
      icon,
      checkedIcon: icon,
      ref,
    ...
    })), (0, import_jsx_runtime20.jsx)(SwitchTrack, {
...
var Toolbar = React19.forwardRef(function Toolbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(ToolbarRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ownerState
...
var _FirstPageIcon2;
var _LastPageIcon2;
var _excluded15 = ["backIconButtonProps", "count", "disabled", "getItemAriaLabel", "nextIconButtonProps", "onPageChange", "page", "rowsPerPage", "showFirstButton", "showLastButton", "slotProps"];
var TablePaginationActions = React24.forwardRef(function TablePaginationActions2(props, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)("div", _extends({
    ...
    children: [showFirstButton && (0, import_jsx_runtime28.jsx)(IconButton_default, _extends({
    ...
    })), showLastButton && (0, import_jsx_runtime28.jsx)(IconButton_default, _extends({
...
var _InputBase;
var _excluded16 = ["ActionsComponent", "backIconButtonProps", "className", "colSpan", "component", "count", "disabled", "getItemAriaLabel", "labelDisplayedRows", "labelRowsPerPage", "nextIconButtonProps", "onPageChange", "onRowsPerPageChange", "page", "rowsPerPage", "rowsPerPageOptions", "SelectProps", "showFirstButton", "showLastButton", "slotProps"];
...
//# sourceMappingURL=chunk-2X6ZAJBJ.js.map
