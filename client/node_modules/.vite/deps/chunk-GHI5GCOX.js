...
function useSlider(parameters) {
  ...
  values2 = values2.map((value) => clamp(value, min3, max3));
...
var Badge = React14.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime11.jsxs)(Root, _extends({}, rootProps, {
    children: [children2, (0, import_jsx_runtime10.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime30.jsx)(React51.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GHI5GCOX.js.map
