...
import {getListarFichasTecnicas, postCreateFichaTecnica, eliminarFichaTecnica, putActivarFichaTecnica, putDesactivarFichaTecnica} from "../../api/Rutas.ficha"
...
return(
    ...
    value={{listar,ShowFichasTecnicas,searchTerm,setSearchTerm, activarFichaTecnica, eliminarFichasTecnicas, desactivarFichaTecnica, validacionFichaTecnica ,filtrarDesactivados}}>
    {children}
    </FichaTecnicaContext.Provider>
)
}
